...
#
"""
This module contains common functions used in Rabit.
"""
...
from rabit.exceptions import TimeoutError
...
class RabitEncoder(json.JSONEncoder):
    """
    ...
    * binary strings (python 3)
    ...
    def default(self, obj):
        ...
        return super(RabitEncoder, self).default(obj)
